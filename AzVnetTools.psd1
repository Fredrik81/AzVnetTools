...
@{
    ...
    Description            = 'Module to help find next free Subnet in Azure Virtual Network and more'
    ...
    PrivateData            = @{
        ...
        PSData = @{
            ...
            Tags                     = @('Core', 'desktop', 'Azure', 'VirtualNetwork', 'vnet', 'subnet', 'Network', 'CIDR')
            ...
            IconUri                  = 'https://raw.githubusercontent.com/Fredrik81/AzVnetTools/refs/heads/main/AzVnetTools.png'
